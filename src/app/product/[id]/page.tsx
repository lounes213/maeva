...
export default function ProductDetailsPage() {
  ...
  const safeImageUrls = product?.imageUrls || [];
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        setProduct({
          ...data.data,
          imageUrls: data.data.imageUrls || [] // Ensure imageUrls is always an array
        });
      } catch (error) {
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-6 mb-8">
              ...
              {sizes.length > 0 ? (
                ...
                <div className="text-sm text-gray-500">Aucune taille disponible</div>
              )}
              ...
              <button 
                ...
                onClick={() => {
                  if (navigator.share) {
                    ...
                    alert('Le partage n\'est pas supporté dans ce navigateur.');
                  }
                }}
              >
                <Share2 size={16} />
